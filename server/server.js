...
? ['https://dss-desdemona.onrender.com', 'https://desdemonapp.onrender.com']: ['http://localhost:3000', 'https://desdemonapp.onrender.com'];
...
app.put('/api/modifyOperatorFeature', (req, res) => {
    try {
        ...
        // Call the DesGeneralApi method to modify the operator features
...
app.put('/api/modifyTaskFeatures', (req, res) => {
    try {
        ...
        console.log('Calling DesGeneralApi.modifyTaskFeatures...');
